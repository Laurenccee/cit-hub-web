...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        'flex-1 autofill:bg-transparent autofill:transition-colors autofill:duration-[5000000s] rounded-none border-0 bg-transparent shadow-none  ring-0 focus-visible:ring-0 aria-invalid:ring-0 dark:bg-transparent',
        className,
      )}
      {...props}
    />
