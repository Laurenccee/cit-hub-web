...
export function MobileNav({ onSignOut, isPending, isAuthenticated }: MobileNavProps) {
        ...
        <div className="md:hidden">
            <Sheet open={open} onOpenChange={setOpen}>
                ...
                <SheetContent side="right" className="w-75 sm:w-100 p-8">
                    <SheetTitle className="text-left font-serif text-2xl text-primary mb-8">CIT MENU</SheetTitle>
