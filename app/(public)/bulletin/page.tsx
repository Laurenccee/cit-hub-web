                        ...
                        {featuredNews && featuredNews.length > 0 ? (
                            ...
                            <Card className="flex items-center justify-center min-h-64 bg-muted/30 border-dashed">
                                <CardContent className="flex flex-col items-center gap-3 text-center py-12">
                                    <p className="text-lg font-medium text-muted-foreground">No news published yet</p>
                        ...
                        <section className="flex flex-col sm:flex-row sm:items-end gap-4">
                            <div className="flex flex-col flex-1">
                                ...
                                <span className="text-sm text-muted-foreground">
                                    Stay updated with the latest news and events at CIT. Check out our school bulletin
                                    for important announcements, upcoming events, and student achievements.
                                </span>
                            </div>
