...
export const LATEST_NEWS: NewsItem[] = [
    {
        ...
        content:
            'Aklan State University once again demonstrated its strong commitment to community service. Indeed, every drop counts. Together, we can make a difference and save lives.',
